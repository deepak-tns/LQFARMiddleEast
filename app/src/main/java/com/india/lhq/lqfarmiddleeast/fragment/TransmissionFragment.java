...
public class TransmissionFragment extends Fragment implements View.OnClickListener {
    ...
    private RadioGroup radioQues12, radioQues13, radioQues14, radioQues15, radioQues16, radioQues17, radioQues18, radioQues19, radioQues20, radioQues21,radioQues22;
    private RadioButton yes1, yes2, yes3, yes4, yes5, yes6, yes7, yes8, yes9, yes10, yes11, yes12, yes13, yes14,yes15,yes16,yes17,yes18, yes19, yes20, yes21, yes22;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_transmission, container, false);
        db = new DatabaseHandler(getActivity());
        findids(v);
        tv_count_previous.setText(tv_count_previous.getText().toString()+db.getCountTransmissionData()+"");

        if(db.getCountTransmissionData()> 2){
            db.deleteSomeRow_Transmission();
        }
    ...
    public void onClick(View v) {
        if(v == btn_save)
        {
            ...
            db.insertTransmissionData(new TransmissionData(edt_ques1.getText().toString(),edt_ques2.getText().toString(),edt_ques3.getText().toString(),edt_ques4.getText().toString(),edt_ques5.getText().toString(),edt_ques6.getText().toString(),edt_ques7.getText().toString(),edt_ques8.getText().toString(),edt_ques9.getText().toString(),edt_ques10.getText().toString(),edt_ques11.getText().toString(),edt_ques12.getText().toString(),edt_ques13.getText().toString(),edt_ques14.getText().toString(),edt_ques15.getText().toString(),edt_ques16.getText().toString(),
                    ...
                    yes21.getText().toString(),yes22.getText().toString(),1));

            tv_count_after.setText(db.getCountTransmissionData()+"");

            Toast.makeText(getActivity(), "All record has been Successfully", Toast.LENGTH_SHORT).show();
        }
        if (v == btn_next) {

            getFragmentManager().beginTransaction().replace(R.id.frameLayout_home_frag,new CableInletsFragment()).addToBackStack(null).commit();
        }
    }
}
