 ...
 */
public class EquipmentRoomInvestigationFragment extends Fragment implements View.OnClickListener {

    private EditText edt_ques1;
    private EditText edt_ques2;
    private EditText edt_ques3;
    private EditText edt_ques4;
    private EditText edt_ques5_Type;
    private EditText edt_ques5_Dimension;
    ...
    private RadioGroup radioQues8, radioQues9, radioQues10, radioQues11, radioQues12, radioQues13, radioQues14, radioQues15, radioQues16, radioQues17;
    ...
    public EquipmentRoomInvestigationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_equipment_room_investigation, container, false);

        db = new DatabaseHandler(getActivity());
        findids(v);
        tv_count_previous.setText(tv_count_previous.getText().toString()+db.getCountTABLE_EQUIPMENTROOMINVESTIGATIONData());

        if(db.getCountTABLE_EQUIPMENTROOMINVESTIGATIONData()> 2){
            db.deleteSomeRow_EquipmentRoomInvestigation();
        }
        return v;
    }
    ...
    private void findids(View v) {
        ...
        edt_ques5_Type = v.findViewById(R.id.edt_ques5_Type);
        edt_ques5_Dimension = v.findViewById(R.id.edt_ques5_Dimension);
    ...
    public void onClick(View v) {
        if(v == btn_save) {
            ...
            db.insertEQUIPMENTROOMINVESTIGATIONData(new EquipmentRoomInvestigationData(edt_ques1.getText().toString(),edt_ques2.getText().toString(),edt_ques3.getText().toString(),edt_ques4.getText().toString(),edt_ques5_Type.getText().toString(),edt_ques5_Dimension.getText().toString(),edt_ques6.getText().toString(),edt_ques7.getText().toString(),edt_ques8.getText().toString(),edt_ques9.getText().toString(),edt_ques10.getText().toString(),edt_ques11.getText().toString(),edt_ques12.getText().toString(),edt_ques13.getText().toString(),edt_ques14.getText().toString(),edt_ques15.getText().toString(),edt_ques16.getText().toString(),edt_ques17.getText().toString(),
            ...
            tv_count_after.setText(db.getCountTABLE_EQUIPMENTROOMINVESTIGATIONData()+"");

            Toast.makeText(getActivity(), "All record has been Successfully", Toast.LENGTH_SHORT).show();
        }
        if (v == btn_next) {

            getFragmentManager().beginTransaction().replace(R.id.frameLayout_home_frag,new PowerBatteryBackupFragment()).addToBackStack(null).commit();
        }
    }
}
