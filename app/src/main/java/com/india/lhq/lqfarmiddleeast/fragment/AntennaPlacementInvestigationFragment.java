 ...
 */
public class AntennaPlacementInvestigationFragment extends Fragment implements View.OnClickListener {
    ...
    private RadioGroup radioQues8, radioQues9, radioQues10, radioQues11, radioQues12, radioQues13, radioQues14, radioQues15;
    private RadioButton yes1, yes2, yes3, yes4, yes5, yes6, yes7, yes8, yes9, yes10, yes11, yes12, yes13, yes14, yes15;
    private EditText edt_sectorA_azimuth, edt_sectorA_height, edt_sectorB_azimuth, edt_sectorB_height, edt_sectorC_azimuth, edt_sectorC_height, edt_sectorD_azimuth, edt_sectorD_height;
    ...
    public AntennaPlacementInvestigationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_antenna_placement_investigation, container, false);

        db = new DatabaseHandler(getActivity());
        findids(v);
        tv_count_previous.setText(tv_count_previous.getText().toString() + db.getCountAntennaPlacementInvestigationData() + "");

        if(db.getCountAntennaPlacementInvestigationData()> 2){
            db.deleteSomeRow_AntennaPlacementInvestigation();
        }
    ...
    private void findids(View v) {
        ...
        edt_sectorA_azimuth = v.findViewById(R.id.edt_sectorA_azimuth);
        edt_sectorA_height = v.findViewById(R.id.edt_sectorA_height);
        edt_sectorB_azimuth = v.findViewById(R.id.edt_sectorB_azimuth);
        edt_sectorB_height = v.findViewById(R.id.edt_sectorB_height);
        edt_sectorC_azimuth = v.findViewById(R.id.edt_sectorC_azimuth);
        edt_sectorC_height = v.findViewById(R.id.edt_sectorC_height);
        edt_sectorD_azimuth = v.findViewById(R.id.edt_sectorD_azimuth);
        edt_sectorD_height = v.findViewById(R.id.edt_sectorD_height);
    ...
    public void onClick(View v) {
        if (v == btn_save) {
            ...
            db.insertAntennaPlacementInvestigationData(new AntennaPlacementInvestigationData(edt_ques1.getText().toString(), edt_ques2.getText().toString(), edt_ques3.getText().toString(), edt_ques4.getText().toString(), edt_ques5.getText().toString(), edt_ques6.getText().toString(), edt_ques7.getText().toString(), edt_ques8.getText().toString(), edt_ques9.getText().toString(), edt_ques10.getText().toString(), edt_ques11.getText().toString(), edt_ques12.getText().toString(), edt_ques13.getText().toString(), edt_ques14.getText().toString(), edt_ques15.getText().toString(),
                    yes1.getText().toString(), yes2.getText().toString(), yes3.getText().toString(), yes4.getText().toString(), yes5.getText().toString(), yes6.getText().toString(), yes7.getText().toString(), yes8.getText().toString(), yes9.getText().toString(), yes10.getText().toString(), yes11.getText().toString(), yes12.getText().toString(), yes13.getText().toString(), yes14.getText().toString(), yes15.getText().toString(),edt_sectorA_azimuth.getText().toString(),edt_sectorA_height.getText().toString(),edt_sectorB_azimuth.getText().toString(),edt_sectorB_height.getText().toString(),edt_sectorC_azimuth.getText().toString(),edt_sectorC_height.getText().toString(),edt_sectorD_azimuth.getText().toString(),edt_sectorD_height.getText().toString(), 1));

            tv_count_after.setText(db.getCountAntennaPlacementInvestigationData() + "");
        }
        if (v == btn_next) {

            getFragmentManager().beginTransaction().replace(R.id.frameLayout_home_frag,new SitePhotoFragment()).addToBackStack(null).commit();
        }
    }
}
